    ...
    while (valid_answers != 1):
        ...
        for vector in matrix:
            ...
            if (f"{temp_lp}" == f"{lp}"):
                valid_answers += 1
    # Question text
    pretext = "Suppose you have an array of size 8 and have been given\n" \
...
def result() -> NoReturn:
    ...
    # Question variables
    lp_size = 11
    rarray = return_rarray(_max=53, size=randint(7, 9))
    lp = LinearProbe(lp_size, rarray)
    # Question text
    pretext = "Suppose you have an array of size 11 and have been given\n" \
              "the following simple hash function"
...
def search() -> NoReturn:
    # Question variables
    lp_size, arr = 11, return_rarray(_max=53, size=randint(6, 8))
...
def deletion() -> NoReturn:
    ...
    while (delrv != shift):
        ...
        lp_size, arr = 11, return_rarray(_max=64, size=randint(8, 9))
        lp = LinearProbe(lp_size, arr)
